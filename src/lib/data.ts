export const SITE_CONTENT = {
  hero: {
    image: "/images/hero/Creation_of_Jeffrey600x1200.jpg",
    title: "Capturing Architecture & Life.",
    subtitle: "Sydney based Commercial & Portrait Photography.",
  },
  about: {
    image: "/images/about/IncredulityofJeffreyLowRes.jpg",
  ...
  gallery: [
    {
      id: 1,
      src: "/images/portfolio/entombment.jpg",
      alt: "Entombment – editorial photography",
      category: "Architecture",
    },
    {
      id: 2,
      src: "/images/portfolio/marvel.jpg",
      alt: "Marvel – portrait work",
      category: "Portrait",
    },
    {
      id: 3,
      src: "/images/portfolio/VictoryEdit.jpg",
